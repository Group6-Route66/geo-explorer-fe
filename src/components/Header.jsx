...
const Header = () => {
  ...
  return (
    <header className="container sticky top-0 z-1 bg-white w-full max-w-full mx-0 md:mx-auto px-4 lg:max-w-5xl flex justify-between items-center p-4 shadow-md rounded-sm dark:bg-gray-800">
      <Link href="/">
        <LogoIcon />
      </Link>
      <Link href="/">
